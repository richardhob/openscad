...
CONNECTOR_A_WIDTH_INCHES = SIDE_A_TOP_INCHES - 2*CONNECTOR_A_OFFSET_INCHES;

CONNECTOR_B_OFFSET_INCHES = 0.08;
CONNECTOR_B_WIDTH_INCHES = SIDE_A_TOP_INCHES - 2*CONNECTOR_A_OFFSET_INCHES;
...
module short(length, height) {
    ...
    // BOTTOM CONNECTOR
    translate([0, 0, 0]) rotate([0, -90, 0]) connector(CONNECTOR_A_WIDTH, CONNECTOR_A_OFFSET, cutout_depth=3, side_b_base=0.8*SIDE_B_BASE);
}
